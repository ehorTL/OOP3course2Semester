...
public class ConcurentSkipList {
        ...
        while (true) {
            ...
            try {
                ...
                for (int level = 0; (valid && (level <= newLevel)); level += 1) {
                    ...
                    valid = !predecessor.markedForRemoval && !successor.markedForRemoval
            ...
            if (inProcessOfRemoving || (foundNodeLevel != -1 && canDelete(successors[foundNodeLevel], foundNodeLevel))) {
                ...
                try {
                    ...
                    for (int level = 0; (valid && (level <= highestLevelFound)); level += 1) {
                        ...
                        valid = !predecessor.markedForRemoval && predecessor.forward[level] == successor;
                    }
    ...
    public boolean contains(Object value) {
        ...
        return foundNodeLevel != -1 && successors[foundNodeLevel].fullyLinked && !successors[foundNodeLevel].markedForRemoval;
    }
